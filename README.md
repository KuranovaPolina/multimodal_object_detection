...
### Описание моделей
В проекте представлен путь модификаций четырёхканальной rgb-d модели с простейшим слиянием, основанной на статье [https://arxiv.org/abs/2411.09062?utm_source=chatgpt.com] , в дальнейшем базовая модель.
...
#### Модель 2: 4 канальная модель с механизмом гейтирования (gating_model)
...
#### Модель 3: 5 канальная модель с механизмом гейтирования (rgbdd_gating_model)
...
#### Модель 4: 5 канальная модель с механизмом внимания (rgbdd_attention_model)
