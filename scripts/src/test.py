...
def predict_1_sample(classes, rgb, depth, model, img_size, depth_min, depth_max, device, score_thresh=0.5):
...
def show_n_predictions(model, samples, classes, depth_min, depth_max, img_size, device, n = 5, score_thresh=0.5):
    ...
    for idx, sample in enumerate(chosen):
        ...
        rgb_vis = predict_1_sample(classes, rgb, depth, model, img_size, depth_min, depth_max, device)
